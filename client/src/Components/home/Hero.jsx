const Hero = () => (
  <section className="bg-slate-900 text-white py-24 px-6 text-center">
    <h1 className="text-5xl md:text-6xl font-extrabold mb-6">
      Your Academic Journey, <span className="text-emerald-400">Simplified.</span>
    </h1>
    ...
    <div className="flex justify-center gap-4">
      <button className="bg-emerald-500 px-8 py-3 rounded-xl font-bold hover:scale-105 transition">Find Papers</button>
